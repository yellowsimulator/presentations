...
\begin{figure}[H]
	\begin{center}
		\begin{tikzpicture}
\node (process) [startstop] {\textcolor{orange}{Process}};
\node (data) [startstop, below of=process, yshift=-1cm] {\textcolor{blue}{Data}};
\node (model) [startstop, below of=data, yshift=-1cm] {Model};
...
\end{frame}
%\begin{frame}
%	\frametitle{Goal of data science in Predictive maintenance}
%	\begin{figure}[H]
%		\centering
%		\includegraphics[width=0.8\linewidth]{target}
%		%\caption{}
%		%\label{fig:datascience}
%	\end{figure}
%\end{frame}
